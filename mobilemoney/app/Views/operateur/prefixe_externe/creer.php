...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0 fw-bold">Ajouter un préfixe externe</h1>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        ...
        <form action="<?= site_url('operateur/prefixe-externe/enregistrer') ?>" method="post">
            <?= csrf_field() ?>
            <div class="row g-4">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" 
                           ...
                           value="<?= old('nom_operateur_externe') ?>" 
                           required 
                           maxlength="100"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" 
                           ...
                           value="<?= old('pourcentage_commission') ?>" 
                           required 
                           placeholder="Ex: 1.5">
                </div>
            </div>
